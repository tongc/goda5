...
public class AggregateWordCount {
	...
	public static class WordCountPlugInClass extends
		...
		public ArrayList<Entry<Text, Text>> generateKeyValPairs(Object key,
			...
			while (itr.hasMoreTokens()) {
				Entry<Text, Text> e = generateEntry(countType, itr.nextToken(),
						ONE);
				if (e != null) {
					retv.add(e);
				}
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
		args = new String[] { "/Users/tonchen/dev/pmd_report.html.out",
				"/Users/tonchen/dev/tools/oo2" };

		//createSequenceFile(args[0], args[0] + ".out");
	...
	private static void createSequenceFile(String inFilePath, String outFilePath) throws IOException, InterruptedException, ClassNotFoundException {
	    ...
	    TextInputFormat.addInputPath(job, new Path(inFilePath));
	    SequenceFileOutputFormat.setOutputPath(job, new Path(outFilePath));
